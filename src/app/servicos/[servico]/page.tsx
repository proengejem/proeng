...
const services = [
  ...
  },
  {
    ...
    gallery: [
      { title: "", url: "#", src: "/image4.png", alt: "Imagem 4" },
      { title: "", url: "#", src: "/image5.png", alt: "Imagem 5" },
      { title: "", url: "#", src: "/image6.png", alt: "Imagem 6" },
    ],
  },
  {
  ...
  },
  {
    ...
    image: "/Tirante.png",
    gallery: [
      { title: "Obra 1", url: "#", src: "/image4.png", alt: "Imagem 4" },
      { title: "Obra 2", url: "#", src: "/image5.png", alt: "Imagem 5" },
      { title: "Obra 3", url: "#", src: "/image6.png", alt: "Imagem 6" },
    ],
  },
...
export default function ServicoPage({ params }: { params: { servico: string } }) {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      {/* Conteúdo principal */}
      <main className="container mx-auto px-80 py-20"> {/* Espaçamento lateral aumentado */}
        <h1 className="text-4xl font-bold mb-10 text-left">{servico.title}</h1> {/* Espaçamento ajustado */}
        <p className="mb-20 text-lg text-justify">{servico.description}</p> {/* Espaçamento ajustado e fonte maior */}
        <img
          src={servico.image}
          alt={servico.title}
        ...
        {/* Passa a configuração para diminuir o tamanho do título na galeria */}
      <Gallery7
