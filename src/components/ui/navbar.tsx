...
export const Navbar1Defaults: Props = {
  ...
  navLinks: [
    ...
    { title: "Empresa", url: "#" },
    {
      ...
      url: "#",
      subMenuLinks: [
        { title: "Solo Grampeado", url: "#" },
        { title: "Estaca Tipo Raíz", url: "#" },
        { title: "Estaca Hélice Contínua Monitorada", url: "#" },
        { title: "Concreto Projetado", url: "#" },
        { title: "Micro Estacas Projetadas", url: "#" },
        { title: "Injeções de Consolidação", url: "#" },
        { title: "Dreno Sub-Horizontal Profundo (DHP)", url: "#" },
        { title: "Tirantes", url: "#" },
